...
- [x] **P0.0** Scaffold repo: package layout, env, pinned deps, lint/CI skeleton. *DONE = installs clean, trivial test passes.*
...
- [x] **P1.1** Encode `ontology.yaml` (states, tiers, dual-index, dominance, version tag).
- [x] **P1.2** Encode `grammar.yaml` (transition cost matrices). *(needs P1.1)*
